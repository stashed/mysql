...
$ helm repo update
$ helm install stash-mysql-5.7.25-beta.20200708 appscode/stash-mysql -n kube-system --version=5.7.25-beta.20200708
```
...
To install the chart with the release name `stash-mysql-5.7.25-beta.20200708`:
...
To uninstall/delete the `stash-mysql-5.7.25-beta.20200708`:

```console
$ helm delete stash-mysql-5.7.25-beta.20200708 -n kube-system
```
...
```console
$ helm install stash-mysql-5.7.25-beta.20200708 appscode/stash-mysql -n kube-system --version=5.7.25-beta.20200708 --set image.registry=stashed
```
...
```console
$ helm install stash-mysql-5.7.25-beta.20200708 appscode/stash-mysql -n kube-system --version=5.7.25-beta.20200708 --values values.yaml
```
