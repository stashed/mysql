...
$ helm repo update
$ helm install stash-mysql-8.0.3-rc.20200827 appscode/stash-mysql -n kube-system --version=8.0.3-rc.20200827
```
...
To install the chart with the release name `stash-mysql-8.0.3-rc.20200827`:
...
```console
$ helm delete stash-mysql-8.0.3-rc.20200827 -n kube-system
```
...
```console
$ helm install stash-mysql-8.0.3-rc.20200827 appscode/stash-mysql -n kube-system --version=8.0.3-rc.20200827 --set image.registry=stashed
```
...
```console
$ helm install stash-mysql-8.0.3-rc.20200827 appscode/stash-mysql -n kube-system --version=8.0.3-rc.20200827 --values values.yaml
```
