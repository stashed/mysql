...
$ helm repo update
$ helm install stash-mysql-5.7.25-beta.20200709 appscode/stash-mysql -n kube-system --version=5.7.25-beta.20200709
```
...
To install the chart with the release name `stash-mysql-5.7.25-beta.20200709`:
...
To uninstall/delete the `stash-mysql-5.7.25-beta.20200709`:

```console
$ helm delete stash-mysql-5.7.25-beta.20200709 -n kube-system
```
...
```console
$ helm install stash-mysql-5.7.25-beta.20200709 appscode/stash-mysql -n kube-system --version=5.7.25-beta.20200709 --set image.registry=stashed
```
...
```console
$ helm install stash-mysql-5.7.25-beta.20200709 appscode/stash-mysql -n kube-system --version=5.7.25-beta.20200709 --values values.yaml
```
